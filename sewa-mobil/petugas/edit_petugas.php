...
if (isset($_POST['update'])) {
    ...
    $result = mysqli_query($conn, "UPDATE akun SET username='$username', password='$password', nama='$nama_anggota', alamat='$alamat', email='$email', notelp='$notelp' WHERE id_akun='$id_petugas'");
...
$result = mysqli_query($conn, "SELECT * FROM akun WHERE id_akun='$id_petugas'");
...
<body>
    <nav class="navbar navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                ...
                Selamat datang di Menu Edit Petugas, <?php echo $nama ?>
            </a>
            <ul class="navbar-nav ms-2">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="kelola_petugas.php">Kembali</a>
                </li>
            </ul>
        </div>
    </nav>
    <div class="container">
        ...
        <form name="update_anggota" action="edit_petugas.php?id_petugas=<?php echo $id_petugas ?>" method="post">
            <div class="mb-3 row">

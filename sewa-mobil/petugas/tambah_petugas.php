...
if (isset($_POST['insert'])) {
    ...
    if (strlen($password) < 5) {
        ...
        $result = mysqli_query($conn, "INSERT INTO akun (username, password, level, nama, alamat, email, notelp) VALUES ('$username', '$password', 'petugas', '$nama_anggota', '$alamat', '$email', '$notelp')");
...
<body>
    <nav class="navbar navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                ...
                Selamat datang di Menu Tambah Petugas, <?php echo $nama ?>
            </a>
    ...
    <div class="container">
        ...
        <form name="insert_anggota" action="tambah_petugas.php" method="post">
            <div class="mb-3 row">

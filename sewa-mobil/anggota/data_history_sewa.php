...
<html lang="en">
  ...
  <body>
    ...
    $result = mysqli_query($conn, "SELECT * FROM historisewamobil WHERE id_akun=$id_anggota");
    ?>
    ...
    <div class="container mt-5">
      ...
      <br />
      <a
        href="history_sewa.php?id_akun=<?php echo $id_anggota ?>"
        class="btn btn-primary"
        >Kembali</a
      >
      <a
        href="cetak_histori_pinjam.php?id_akun=<?php echo $id_anggota ?>"
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo $user_data['nama_mobil']; ?></td>
